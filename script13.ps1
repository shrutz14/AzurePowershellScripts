#Entire Resource creation + availability set adding 
...
$availabilitySet=New-AzAvailabilitySet -Location $location -ResourceGroupName $resourceGroup -Name $availabilitySetName -Sku aligned -PlatformUpdateDomainCount 5 -PlatformFaultDomainCount 2
